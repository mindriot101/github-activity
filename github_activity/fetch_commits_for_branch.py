...
def query_fetch_commits_for_branch():
    _op = sgqlc.operation.Operation(_schema_root.query_type, name='FetchCommitsForBranch', variables=dict(id=sgqlc.types.Arg(sgqlc.types.non_null(_schema.ID)), first=sgqlc.types.Arg(_schema.Int), after=sgqlc.types.Arg(_schema.String)))
    ...
    _op_node__as__Ref_target__as__Commit = _op_node__as__Ref_target.__as__(_schema.Commit)

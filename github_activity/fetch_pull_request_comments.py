...
def query_fetch_pull_request_comments():
    ...
    _op_node__as__PullRequest_comments_page_info = (
        _op_node__as__PullRequest_comments.page_info()
    )
    _op_node__as__PullRequest_comments_page_info.has_next_page()
    _op_node__as__PullRequest_comments_page_info.end_cursor()
    _op_node__as__PullRequest_comments_edges = (
        _op_node__as__PullRequest_comments.edges()
    )
    _op_node__as__PullRequest_comments_edges_node = (
        _op_node__as__PullRequest_comments_edges.node()
    )
